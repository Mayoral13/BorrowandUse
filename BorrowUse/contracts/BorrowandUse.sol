...
contract BorrowandUse{
    ...
    uint TokentoEth = myogg.CheckBalance(msg.sender).div(rate);
     ...
     myogg.Burn(msg.sender, _value.mul(rate));
    ...
    require(myogg.CheckBalance(address(this)) > _value,"Insufficient Tokens in Contract");
    ...
    function ReturnBorrowedETH()public payable returns(bool success){
        ...
        myogg.Mint(msg.sender,ETHBorrowed[msg.sender].mul(rate));
    ...
    //function to return Tokens borrowed
       ...
       require(myogg.CheckBalance(msg.sender) >= TokensBorrowed[msg.sender],"Insufficient Token Balance");
        require(BorrowedTokens[msg.sender] == true,"Borrow Tokens before you can Return it");
        myogg.Burn(msg.sender,TokensBorrowed[msg.sender]);
        myogg.Mint(address(this),TokensBorrowed[msg.sender]);
